        ...
        <div id="navbar" class="navbar-collapse collapse">
			<form class="navbar-form navbar-right" method="post" action="pocetna.php">
				<div class="form-group">
					<a href="addklasa.php"><input type="button" id="register_btn" class="button" value="Unesite novu putnu klasu" /></a>
		...
		<table id="myTable" style="width:80%;" class="linija">
			<form action='drugiadmin.php' method='post'>
				<tr>
					...
					<th style="height: 50px;  text-align: center; background-color: #699bcc; color: white;">Putna klasa</th>
				
					<th style="height: 50px;  text-align: center; background-color: #699bcc; color: white;">Obriši</th>
				</tr>
			
<?php 
$sql = "SELECT * FROM PutnaKlasa";
...
$counter++;
	echo 
			"<tr >
				<td id='uname'>". $row["NazivPutneKlase"]. "</td> 
			
		
				<td><a href='deleteklasa.php?username=" . $row['NazivPutneKlase'] . "'><input type='button' id='register_btn' class='btn btn-primary' value='Obriši'></a></td> 
