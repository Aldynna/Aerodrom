		...
		<table id="myTable" style="width:80%;" class="linija">
			<form action='drugiadmin.php' method='post'>
				<tr>
					...
					<th style="height: 50px;  text-align: center; background-color: #699bcc; color: white;">Detaljan prikaz korisnickog naloga</th>
					<th style="height: 50px;  text-align: center; background-color: #699bcc; color: white;">Uredi</th>
	...
	echo 
			"<tr >
				...
				<td> " . $row["Prezime"]. " </td>
					...
					<td><a href='details.php?username=" . $row['Username'] . "'><input type='button' id='register_btn' class='btn btn-primary' value='Detaljno'></a></td> 
				<td><a href='editkorisnik.php?username=" . $row['Username'] . "'><input type='button' id='register_btn' class='btn btn-primary' value='Edit'></a></td> 
