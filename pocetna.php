...
require 'dbconfig/config.php';
	...
	$query="select TipKorisnikaID from Korisnik WHERE Username='$username' AND Password='$password'";
	$query_run = mysqli_query($conn,$query);
		if(mysqli_num_rows($query_run)>0)
		{
			
			$row = mysqli_fetch_assoc($query_run);
			if($row["TipKorisnikaID"]==1)
      ...
      <div class="row">
        <div>
		  ...
		  <div style="position: relative;">
           <a href="https://en.wikipedia.org/wiki/Berlin"><img src="imgs/berlin.jpg" style="width:350px;height:250px;"> </a>
		  <a href="https://en.wikipedia.org/wiki/London"><img src="imgs/london.jpg" style="width:350px;height:250px;"></a>
		  <a href="https://en.wikipedia.org/wiki/Rome"><img src="imgs/rim.jpg" style="width:350px;height:250px;"></a>
          <p><a class="btn btn-default" href="#" role="button">Pogledaj sve destinacije &raquo;</a></p>
        </div>
        <div>
          <h2>Popularne destinacije</h2>
          <a href="https://en.wikipedia.org/wiki/Paris"><img src="imgs/pariz.jpg" style="width:350px;height:250px;"> </a>
		  <a href="https://en.wikipedia.org/wiki/Istanbul"><img src="imgs/istanbul.jpg" style="width:350px;height:250px;"></a>
          <p><a class="btn btn-default" href="#" role="button">Pogledaj sve destinacije &raquo;</a></p>
       </div>
        <!--<div>
          <h2>Prevoznici</h2>
